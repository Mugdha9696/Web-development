function validation(){
    ...
    if (emailcheck.test(email)){
        ...
        document.getElementById('erroreamil').innerHTML = "Please follow valid email syntax.";
        return false;
    }
...
function validation1(){
    ...
    if (emailcheck.test(email)){
        ...
        document.getElementById('erroreamil1').innerHTML = "Please follow valid email syntax.";
        return false;
    }
